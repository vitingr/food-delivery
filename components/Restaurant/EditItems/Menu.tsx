            ...
            <div className='mt-[50px] p-6 border border-neutral-200 rounded-xl' key={category.id}>
              ...
              <div className='border-t border-neutral-200'>
                ...
                <div className='flex justify-between items-center w-full mt-12'>
                  ...
                  <div className='w-full flex justify-end text-[#ea1d2c] cursor-pointer underline-offset-4 underline' onClick={() => editCategory(category.id)}>
                    Editar Categoria
                  </div>
                </div>
              </div>
