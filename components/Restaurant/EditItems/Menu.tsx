      ...
      {createProduct ? (
        <Popup title={"Adicionar Produto"} state={setCreateProduct}>
          <form onSubmit={(e: React.SyntheticEvent) => {
            ...
            <Upload setState={(value: any) => setProductFoto(value)} currentFoto={productFoto} styles='mt-[-565px] w-full mt-[-20px] absolute opacity-0 cursor-pointer max-w-[450px] mt-[0px]' text='Enviar imagem do produto' />
