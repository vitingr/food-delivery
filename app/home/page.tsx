    ...
    <div className='w-full flex flex-col items-center sm:p-[10%]'>
      ...
      <section className='max-w-[1600px] w-full'>
        ...
        <div className='w-full flex flex-wrap sm:justify-normal justify-between sm:gap-6 gap-14 mt-14'>
          <SmallRestaurantOption color="bg-[#bceca0]" image='https://cdn3.iconfinder.com/data/icons/3d-black-friday/512/basket.png' name='Mercado' />
          <SmallRestaurantOption color="bg-[#fff19f]" image='https://png.pngtree.com/png-vector/20230918/ourmid/pngtree-picanha-and-salad-brazilian-food-png-image_10093980.png' name='Brasileira' />
          <SmallRestaurantOption color="bg-[#bceca0]" image='https://static.wixstatic.com/media/b617de_6d6f1d19c89747268fc6fbe5f6f5ac32~mv2.png/v1/crop/x_1315,y_624,w_5166,h_3917/fill/w_342,h_258,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/MARMITA_03.png' name='Marmita' />
          <SmallRestaurantOption color="bg-[#ffc3cf]" image='https://www.imagensempng.com.br/wp-content/uploads/2021/06/03-20.png' name='Lanches' />
          <SmallRestaurantOption color="bg-[#ffc3cf]" image='https://outback-prod.s3-ap-southeast-1.amazonaws.com/image/ds-BABY-BACK-PORK-RIBS-128.png' name='Carnes' />
          <SmallRestaurantOption color="bg-[#d0a8ef]" image='https://img2.deliverydireto.com.br/unsafe/origxorig/https://duisktnou8b89.cloudfront.net/img/items/626990ac6a139.png' name='Japonesa' />
          <SmallRestaurantOption color="bg-[#bceca0]" image='https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/53f59ee3-60ce-4d32-8885-c6f05457259c/dfoc3b1-a21e369b-cb5d-4fbf-8f48-62b303fbf978.png/v1/fill/w_600,h_600/healthy_food_png_transparent_background__9__by_anavrin_stock_dfoc3b1-fullview.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..yK-vMh2bpOTZCqRKdl1boSEZsn0IMFQJaFnhtcZ1j4w' name='Saudável' />
          <SmallRestaurantOption color="bg-[#bceca0]" image='https://static.vecteezy.com/system/resources/previews/009/887/173/non_2x/spaghetti-italian-pasta-with-tomato-sauce-free-png.png' name='Italiana' />
          <SmallRestaurantOption color="bg-[#d0a8ef]" image='https://freepngimg.com/save/139366-healthy-food-plate-free-download-png-hq/643x645' name='Gourmet' />
          <SmallRestaurantOption color="bg-[#fff19f]" image='https://png.monster/wp-content/uploads/2022/06/png.monster-608.png' name='Padarias' />
          <SmallRestaurantOption color="bg-[#ffc3cf]" image='https://pngimg.com/uploads/noodle/noodle_PNG34.png' name='Chinesa' />
        </div>
      </section>
