    ...
    if (
      ...
      try {
        const response = await fetch(
          "https://food-delivery-nest-api.vercel.app/restaurant/create",
          {
            method: "POST",
            headers: {
  ...
  return (
    <div className="w-full flex flex-col p-[5%] items-center">
      ...
      <div className="max-w-[550px] w-full">
        <h1 className="w-full text-[#ea1d2c] text-xl tracking-wider mb-20 text-center underline-offset-8 underline cursor-pointer">
          Etapa {step} de 2
        </h1>
        ...
        >
          {step === 1 && (
            <>
              ...
              <input
                ...
                onChange={(e) => verifyRG(e.target.value)}
                required
              />

              <label htmlFor="orgao-emissor" className="text-lg">
                Orgão Emissor
              </label>
              <select
                name="orgao-emissor"
              ...
              orgaoEmissor !== "" ? (
                ...
                <button className="mt-12 w-full bg-[#dddddd] rounded-xl p-4 text-center text-[#717171] font-bold cursor-not-allowed">
                  Continuar
                </button>
              )}
            </>
          ...
          {step === 2 && (
            <>
              <p
                className="text-[#717171] mb-6 underline-offset-2 underline cursor-pointer text-sm"
                onClick={() => lastStep()}
              >
                Voltar
              </p>
              ...
              <label htmlFor="cnpj" className="text-lg">
                CPNJ
              </label>
              <input
                type="text"
